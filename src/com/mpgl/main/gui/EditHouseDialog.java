 ...
 * 
 */
public class EditHouseDialog extends BaseDialog {

	private static final long serialVersionUID = 7039851798806876513L;
	 ...
	 *            主窗口
	 */
	public EditHouseDialog(JFrame frame) {
		super(frame);
		this.frame = frame;
		init();
	}
	 ...
	 */
	private void save() {
		houseVo.setId(form.getHouse_id());
		...
		mainService.updateHouseNumber(houseVo);
		this.close();
	}
	...
	private void initForm(String id) {
		form.setHouse_id(id);
		Map<String, Object> map = mainService.queryHouseNumber(form);
		textCity.setText(CommonUtil.getString(map.get("city")));
		textDescription.setText(CommonUtil.getString(map.get("description")));
		textHouseNumPoint.setText(CommonUtil.getString(map
				.get("house_num_point")));
		textHouseNumPosition.setText(CommonUtil.getString(map
				.get("house_num_position")));
		textNature.setText(CommonUtil.getString(map.get("nature")));
		textMark.setText(CommonUtil.getString(map.get("mark")));
		textNowHouseNum.setText(CommonUtil.getString(map.get("now_house_num")));
		textNowUserName.setText(CommonUtil.getString(map.get("now_user_name")));
		textNowUserPhone
				.setText(CommonUtil.getString(map.get("now_user_phone")));
		textOldHouseNum.setText(CommonUtil.getString(map.get("old_house_num")));
		textPropertyName
				.setText(CommonUtil.getString(map.get("property_name")));
		textPropertyPhone.setText(CommonUtil.getString(map
				.get("property_phone")));
		textRoadLevel.setText(CommonUtil.getString(map.get("road_level")));
		textRoadDirection.setText(CommonUtil.getString(map
				.get("road_direction")));
		textRoadName.setText(CommonUtil.getString(map.get("road_name")));
		textRoadStartEnd
				.setText(CommonUtil.getString(map.get("road_start_end")));
	}
